...
namespace Xch.Tests.Services
{
    public class CurrencyRateProviderFixture : IDisposable
    {
        ...
        public CurrencyRatesSnapshot ExpectedRates0 => new CurrencyRatesSnapshot(new DateTime(1971, 01, 01), new[]
        {
            new CurrencyRate("HUF", 0.000001),
        });

        public CurrencyRatesSnapshot ExpectedRates1 => new CurrencyRatesSnapshot(new DateTime(2018, 01, 01), new[]
        {
